...
hermes cron create "0 2 * * *" \
  "You are a project manager triaging the hamr-hub/Hermes-Agent GitHub repo.

1. Run: gh issue list --repo hamr-hub/Hermes-Agent --state open --json number,title,labels,author,createdAt --limit 30
...
hermes cron create "0 9 * * 1" \
  "Scan the hamr-hub/Hermes-Agent repo for documentation drift.

1. Run: gh pr list --repo hamr-hub/Hermes-Agent --state merged --json number,title,files,mergedAt --limit 30
