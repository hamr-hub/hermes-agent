...
```bash
pip install git+https://github.com/hamr-hub/Hermes-Agent.git
```

Or with [uv](https://docs.astral.sh/uv/):

```bash
uv pip install git+https://github.com/hamr-hub/Hermes-Agent.git
```

You can also pin it in your `requirements.txt`:

```text
hermes-agent @ git+https://github.com/hamr-hub/Hermes-Agent.git
```
