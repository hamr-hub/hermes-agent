...
```bash
git clone --recurse-submodules https://github.com/hamr-hub/Hermes-Agent.git
cd hermes-agent
...
- **Profile-safe paths**: Never hardcode `~/.hermes` — use `get_hermes_home()` from `hermes_constants` for code paths and `display_hermes_home()` for user-facing messages. See [AGENTS.md](https://github.com/hamr-hub/Hermes-Agent/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
...
- Use [GitHub Issues](https://github.com/hamr-hub/Hermes-Agent/issues)
...
By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/hamr-hub/Hermes-Agent/blob/main/LICENSE).
