...
nix run github:hamr-hub/Hermes-Agent -- setup
nix run github:hamr-hub/Hermes-Agent -- chat

# Or install persistently
nix profile install github:hamr-hub/Hermes-Agent
hermes setup
hermes chat
```
...
```bash
git clone https://github.com/hamr-hub/Hermes-Agent.git
cd hermes-agent
nix build
...
# /etc/nixos/flake.nix (or your system flake)
{
  inputs = {
    ...
    hermes-agent.url = "github:hamr-hub/Hermes-Agent";
  };
...
```nix
{
  inputs.hermes-agent.url = "github:hamr-hub/Hermes-Agent";
