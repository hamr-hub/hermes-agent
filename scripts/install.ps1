...
#
# Usage:
#   irm https://raw.githubusercontent.com/hamr-hub/Hermes-Agent/main/scripts/install.ps1 | iex
#
...
$RepoUrlSsh = "git@github.com:hamr-hub/Hermes-Agent.git"
$RepoUrlHttps = "https://github.com/hamr-hub/Hermes-Agent.git"
$PythonVersion = "3.11"
$NodeVersion = "22"
...
function Install-Repository {
    ...
    if (Test-Path $InstallDir) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                $zipUrl = "https://github.com/hamr-hub/Hermes-Agent/archive/refs/heads/$Branch.zip"
...
try {
    ...
    Write-Host "  Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/hamr-hub/Hermes-Agent/main/scripts/install.ps1' -OutFile install.ps1" -ForegroundColor Yellow
