...
Built for [Hermes Agent](https://github.com/hamr-hub/Hermes-Agent). Usable in any coding agent. Canonical source lives here; synced to [`hamr-hub/Hermes-Agent/skills/creative/ascii-video`](https://github.com/hamr-hub/Hermes-Agent/tree/main/skills/creative/ascii-video) via PR.
